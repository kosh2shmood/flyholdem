...
## Current phase
Gate 2 passed five independent full-graph conditioning seeds: 82.3% learned versus 47.2% frozen and 50.0% shuffled, with retention, erasure and independent journal audit. Mechanism is learned readout suppression under the fixed legal tie rule; this is not poker learning. CI passed and conditioning-v0 is published on 0559886.

The 25,000- and 250,000-hand NFSP teachers failed development against the complete opponent suite. No validated teacher, corpus or poker transfer exists. Register the next conventional-teacher candidate with 354 visible-state features; the fly's fixed 237-channel encoder is unchanged. Full suite: 68 passed / 2 isolated-oracle skips. Independent engineering and actual transfer integrity remain next. The public live table remains the labeled fixture. Original build, poker optimization and human heads-up play are required; the goal stays active.
