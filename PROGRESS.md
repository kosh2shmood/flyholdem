...
## Current phase
M4 conditioning development qualified at the third preregistered learning rate (0.3): 84.4% plastic versus 45.8% frozen / 43.8% shuffled, with retention and exact erasure checks. Rates 0.03 and 0.1 failed and remain published. Five independent confirmation seeds now passed: 82.3% plastic versus 47.2% frozen and 50.0% shuffled; retention and exact erasure passed. Gate 2 is complete. Create/push conditioning-v0 after publishing the checked written evidence and verifying CI.

The conventional NFSP teacher, strict canonical states/corpus safeguards, complete numeric teacher checkpoints and a separate teacher-disconnected native model runtime are implemented. Full suite: 66 passed / 2 isolated-oracle skips. The teacher has not yet been trained or validated in a registered production run. No corpus or transferred poker policy exists. Original build, poker optimization and the human heads-up interface remain required; the goal is active. The public live table remains the labeled fixture.
