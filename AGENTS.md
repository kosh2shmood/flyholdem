...
Read PROGRESS.md and the product specification before continuing. Keep work on astra/visual-first and preserve pushed history. V0 is frozen at visual-demo-v0. Use uv/locked Python 3.11 dependencies and the original project checkout. Keep data, environments, secrets, model checkpoints and large run logs ignored.
